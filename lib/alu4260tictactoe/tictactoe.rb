require "~/LPP/Pract9/alu4260tictactoe/lib/alu4260tictactoe/version"
require "~/LPP/Pract9/alu4260tictactoe/lib/alu4260tictactoe/HumanPlayer.rb"
require "~/LPP/Pract9/alu4260tictactoe/lib/alu4260tictactoe/DumbPlayer.rb"
require "~/LPP/Pract9/alu4260tictactoe/lib/alu4260tictactoe/SmartPlayer.rb"
...
module TicTacToe
  class Arbitrario
   def aleatorio
	...
	if v==1 
	game = TicTacToe::Game.new TicTacToe::HumanPlayer,TicTacToe::HumanPlayer
        game.play  
	end
	if v==2
	...
	if v==3
	game = TicTacToe::Game.new TicTacToe::DumbPlayer,TicTacToe::DumbPlayer
        game.play  
	end
  end 
 end
...
=begin
Faltarian las opciones de Dumplayer VS SmartPlayer pero la deseche al solo ser posibles el empate o la victorio de SmartPlayer
Y la opcion de SmartPlayer VS SmartPlayer pero tambien la deseche al siempre dar emparte como resultado final.
=end
end 
